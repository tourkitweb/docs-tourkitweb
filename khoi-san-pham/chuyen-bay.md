...
Mục **Chuyến bay** dùng để bán vé máy bay do **bạn tự khai báo tay**: bạn tự nhập hãng bay, sân bay đi/đến, giờ bay, loại ghế và giá.

Đây là lựa chọn phù hợp khi bạn có nguồn vé riêng — vé đoàn, vé charter (chuyến bay thuê nguyên chuyến), hoặc vé bạn giữ chỗ sẵn từ đại lý — và muốn bán trên website với giá do bạn quyết định.

> **Đường dẫn:** Menu bên trái > **Chuyến bay**
...
## Chuẩn bị trước khi tạo chuyến bay đầu tiên

Đây là điểm khiến nhiều người mới bị vướng. Bạn **không nên** vào thẳng "Thêm chuyến bay mới", vì trong đó bạn sẽ phải chọn hãng bay và sân bay — mà nếu chưa khai báo thì danh sách sẽ trống rỗng, không có gì để chọn.

Hãy làm theo đúng thứ tự sau:

### Bước 1: Khai báo Hãng hàng không
...
Ở **cột bên phải**, tích chọn các thuộc tính phù hợp (bay thẳng, có hành lý ký gửi…). Đây là thứ giúp khách lọc tìm trên website.

### Bước 4: Lưu và xuất bản

Nhấn **"Lưu thay đổi"**.

> **Cẩn thận:** Lưu xong, chuyến bay có thể vẫn đang ở dạng **bản nháp** (lưu lại nhưng khách chưa nhìn thấy trên web). Bạn phải chuyển sang **xuất bản** (đăng lên cho khách xem được) thì nó mới hiện ra ngoài website.

## Lưu ý & xử lý sự cố

**Trong trang thêm chuyến bay, ô chọn hãng bay hoặc sân bay bị trống:** bạn chưa khai báo chúng. Hãy quay lại phần **Chuẩn bị trước khi tạo chuyến bay đầu tiên** ở trên và làm đủ 3 bước.
...
**Giá hiện sai trên website:** kiểm tra lại bạn đã nhập giá vào đúng **loại ghế** chưa. Giá của hạng Thương gia điền nhầm vào hạng Phổ thông là lỗi thường gặp.

**Chuyến bay đã qua ngày vẫn hiện trên web:** hãy chuyển chúng về **bản nháp** để dọn dẹp danh sách, đừng xóa — vì bạn có thể cần lại dữ liệu đó cho các chuyến tương tự về sau.
