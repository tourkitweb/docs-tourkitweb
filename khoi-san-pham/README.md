...
Khối **SẢN PHẨM** là "kho hàng" của website du lịch. Mọi thứ bạn muốn bán cho khách — một tour Hạ Long 3 ngày, một phòng khách sạn ở Đà Nẵng — đều phải được tạo ra ở đây trước. Nếu chưa có gì trong khối này, website của bạn sẽ trống trơn, khách vào chỉ thấy trang chủ mà không có sản phẩm nào để xem hay đặt.
...
Đây là phần nhiều người mới hay làm ngược và bị rối. Thứ tự đúng là:

1. **Tạo Địa điểm trước.** Vì khi thêm tour hoặc khách sạn, hệ thống sẽ bắt bạn chọn địa điểm. Nếu chưa tạo "Đà Nẵng", bạn sẽ không chọn được nó ở bước sau.
2. **Tạo Danh mục và Thuộc tính.** Đây là các nhóm và tiêu chí để khách lọc tìm. Có sẵn từ đầu thì lúc thêm sản phẩm bạn chỉ việc tích chọn.
3. **Thêm Khách sạn / Tour.** Lúc này mọi thứ đã sẵn sàng, bạn nhập một lần là xong.
4. **Cập nhật giá.** Mở bán ngày nào, giá bao nhiêu — nếu bỏ qua bước này, khách nhìn thấy tour nhưng không đặt được.

> **Mẹo:** Nếu bạn đang vội và đã lỡ thêm tour trước khi tạo địa điểm, đừng lo. Bạn vẫn có thể quay lại tạo địa điểm rồi vào sửa tour để chọn bổ sung. Không mất dữ liệu.

## Trong khối này có gì?

### Địa điểm

Quản lý danh sách quốc gia, tỉnh, thành phố, khu vực (ví dụ: Việt Nam, Hà Nội, Nhật Bản, Tokyo). Đây là dữ liệu nền để mọi tour và khách sạn biết mình "nằm ở đâu", và để khách hàng lọc tìm theo khu vực họ quan tâm.

Xem chi tiết tại bài [3.1. Địa điểm](dia-diem.md).

### Khách sạn

Nơi lưu thông tin các cơ sở lưu trú: tên, mô tả, hình ảnh, hạng sao, tiện ích, các loại phòng và giá phòng theo từng ngày.

Xem chi tiết tại bài [3.2. Khách sạn](khach-san.md).

### Tour

Phần quan trọng nhất với hầu hết doanh nghiệp du lịch. Đây là nơi bạn dựng chương trình tour trọn gói: lịch trình từng ngày, bao gồm gì, không bao gồm gì, chính sách hủy, giá và ngày khởi hành.

Xem chi tiết tại bài [3.3. Tour](tour.md).

### Yêu cầu báo giá

Khách xem tour trên website nhưng chưa đặt ngay mà muốn hỏi giá cho đoàn 20 người, hoặc muốn đổi ngày đi — họ sẽ gửi một yêu cầu báo giá. Toàn bộ các yêu cầu đó đổ về đây để nhân viên kinh doanh của bạn liên hệ lại.

Xem chi tiết tại bài [3.4. Yêu cầu báo giá](yeu-cau-bao-gia.md).

## Các module khác có thể xuất hiện
...
## Một điểm chung rất tiện: các module đều giống nhau
...
**Không thấy nhóm SẢN PHẨM hoặc thiếu một mục nào đó trong menu:** menu hiển thị theo phân quyền. Người dùng không đủ quyền sẽ KHÔNG nhìn thấy mục đó. Nếu bạn không thấy mục mình cần, tài khoản của bạn chưa được cấp quyền — hãy liên hệ quản trị viên của đơn vị bạn.
