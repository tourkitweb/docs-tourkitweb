...
Ví dụ, bạn viết mẫu: `Cảm ơn anh/chị, bên em đã ghi nhận số {phone} và sẽ gọi lại trong 15 phút.`
Khi khách để lại số `0912345678`, bot sẽ nói: "Cảm ơn anh/chị, bên em đã ghi nhận số 0912345678 và sẽ gọi lại trong 15 phút."
...
- [Hướng dẫn sử dụng tính năng AI](README.md) — giới thiệu chung và thứ tự nên làm khi mới bắt đầu
