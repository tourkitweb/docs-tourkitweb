...
**Bước 1 — Xem thông tin để xác minh.** Mỗi yêu cầu hiển thị Tên, Email, Số điện thoại và thông tin ngân hàng (ví dụ: *MB Bank* của đại lý *Vietnamtravel*). Trước khi bấm duyệt, hãy dành 2 phút:
...
- **Tên đại lý** — Đặt tên cho cấp độ này. Ví dụ: *Đại lý Cấp 1*, *Đại lý VIP*, hoặc đơn giản là *Vàng*.
...
- [1. Bảng điều khiển](README.md) — theo dõi doanh thu tổng, bao gồm cả phần do đại lý mang về.
