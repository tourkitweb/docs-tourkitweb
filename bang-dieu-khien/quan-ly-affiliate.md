...
Affiliate (đọc là *a-phi-li-ệt*) là chương trình **giới thiệu ăn hoa hồng**. Cách hoạt động rất đơn giản:
...
> **Mẹo được duyệt nhanh:** admin đọc lý do tham gia để quyết định. Đừng để trống hoặc gõ "abc". Hãy viết ngắn gọn bạn sẽ giới thiệu ở đâu, ví dụ: *"Mình quản trị nhóm Facebook Phượt Miền Bắc 20.000 thành viên, muốn giới thiệu tour cho các bạn trong nhóm."* Câu này khiến bạn nổi bật hơn hẳn.
...
- [1. Bảng điều khiển](README.md) — theo dõi doanh thu tổng để cân đối với chi phí hoa hồng.
