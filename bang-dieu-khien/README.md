...
Bảng điều khiển **không có mục con** nào trong menu. Nó là một màn hình tổng quan duy nhất, được chia làm 3 khu vực từ trên xuống dưới:

1. **Các thẻ chỉ số** — bốn ô vuông ở trên cùng, cho biết những con số quan trọng nhất.
2. **Biểu đồ** — hình vẽ cột màu ở giữa, cho biết xu hướng tăng giảm theo thời gian.
3. **Đặt chỗ gần đây** — bảng danh sách ở dưới cùng, liệt kê các đơn hàng mới nhất.

Chúng ta sẽ đi qua từng khu vực một.

## Khu vực 1: Các thẻ chỉ số kinh doanh
...
> **Đọc bốn số này thế nào cho có ích?** Hãy so **Đặt chỗ** với **Doanh thu**. Nếu số đơn nhiều mà doanh thu thấp, nghĩa là khách chỉ mua các dịch vụ giá rẻ. Nếu số đơn ít mà doanh thu cao, bạn đang sống nhờ một vài khách lớn — cần cẩn thận vì mất một khách là hụt nhiều.
...
> **Mẹo:** Muốn biết tháng này có khá hơn tháng trước không, hãy xem biểu đồ theo tháng của cả hai tháng rồi so chiều cao các cột. Đây là cách nhanh nhất để biết chiến dịch quảng cáo vừa rồi có hiệu quả hay không.

## Khu vực 3: Quản lý đặt chỗ gần đây

Đây là bảng nằm dưới cùng, liệt kê những đơn hàng **mới nhất** vừa đổ về. Khu vực này quan trọng nhất trong ngày làm việc, vì nó cho bạn biết **có việc gì cần làm ngay không**.
...
> **Thói quen nên có:** mỗi sáng mở Bảng điều khiển, nhìn thẳng xuống bảng này và lọc mắt tìm các đơn **"Chưa thanh toán"**. Đó là tiền đang treo lơ lửng — gọi cho khách sớm ngày nào thì khả năng thu được cao ngày đó.

## Lưu ý & xử lý sự cố

**Các con số đều bằng 0 / bảng đặt chỗ trống trơn.** Điều này hoàn toàn bình thường nếu website của bạn vừa mới dựng xong và chưa có khách đặt thật. Hệ thống chỉ hiển thị dữ liệu thật, không tạo số giả. Khi có đơn đầu tiên, các số sẽ tự hiện ra.

**Số liệu có vẻ cũ, không khớp với đơn vừa phát sinh.** Trình duyệt đôi khi giữ lại bản cũ của trang để hiển thị cho nhanh. Hãy nhấn tổ hợp phím **Ctrl + F5** (giữ phím Ctrl rồi bấm F5) để buộc trang tải lại hoàn toàn từ đầu.

**Doanh thu trên Bảng điều khiển không khớp với sổ sách kế toán.** Hai bên tính theo cách khác nhau, chênh lệch là chuyện thường gặp. Bảng điều khiển tính theo đơn hàng ghi nhận trên website; kế toán tính theo tiền thực về tài khoản ngân hàng. Các đơn **"Chưa thanh toán"** hoặc **"Đã hủy"** là nguyên nhân chênh lệch phổ biến nhất.

**Bạn không thấy đủ 4 thẻ chỉ số, hoặc không thấy biểu đồ.** Menu và nội dung hiển thị theo phân quyền của từng tài khoản. Nếu tài khoản của bạn chưa được cấp quyền xem báo cáo tài chính, một số khu vực sẽ bị ẩn đi. Hãy liên hệ quản trị viên của đơn vị bạn để được cấp thêm quyền.

**Màn hình bị vỡ, các thẻ chồng lên nhau.** Thường do cửa sổ trình duyệt quá hẹp hoặc bạn đang phóng to quá mức. Nhấn **Ctrl + 0** (số không) để đưa mức phóng về 100%.
